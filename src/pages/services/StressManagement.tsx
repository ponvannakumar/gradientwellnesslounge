            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="service-card">
                  ...
                  <p className="text-black font-bold">Learn techniques to manage anxiety and worry effectively</p>
                </div>
                <div className="service-card">
                  <h3 className="text-xl font-bold gradient-text mb-4">Better Sleep</h3>
                  <p className="text-black font-bold">Improve sleep quality through stress reduction techniques</p>
                </div>
                <div className="service-card">
                  <h3 className="text-xl font-bold gradient-text mb-4">Enhanced Focus</h3>
                  <p className="text-black font-bold">Develop mental clarity and improved concentration</p>
                </div>
              </div>
            </div>
          </FadeInSection>
